...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.search.setGeometry(QtCore.QRect(10, 330, 131, 51))
        ...
        self.label_6.setGeometry(QtCore.QRect(760, 400, 281, 16))
        self.label_6.setObjectName("label_6")
        self.address = QtWidgets.QTextEdit(Form)
        self.address.setGeometry(QtCore.QRect(760, 430, 281, 121))
        self.address.setReadOnly(True)
        self.address.setObjectName("address")
        self.clear_dots = QtWidgets.QPushButton(Form)
        self.clear_dots.setGeometry(QtCore.QRect(150, 330, 131, 51))
        self.clear_dots.setObjectName("clear_dots")
        self.other_search = QtWidgets.QPushButton(Form)
        self.other_search.setGeometry(QtCore.QRect(760, 320, 131, 51))
        self.other_search.setObjectName("other_search")
        self.other_clear_dots = QtWidgets.QPushButton(Form)
        self.other_clear_dots.setGeometry(QtCore.QRect(900, 320, 131, 51))
