...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.lat.setGeometry(QtCore.QRect(10, 100, 271, 20))
        self.lat.setObjectName("lat")
        self.label_3 = QtWidgets.QLabel(Form)
        self.label_3.setGeometry(QtCore.QRect(10, 170, 271, 16))
        self.label_3.setObjectName("label_3")
        self.scale = QtWidgets.QLineEdit(Form)
        self.scale.setGeometry(QtCore.QRect(10, 200, 271, 20))
        ...
        self.map_showing.setGeometry(QtCore.QRect(10, 140, 91, 19))
        ...
        self.sattelite_showing.setGeometry(QtCore.QRect(110, 140, 91, 19))
        ...
        self.gibrid_showing.setGeometry(QtCore.QRect(210, 140, 91, 19))
        self.gibrid_showing.setObjectName("gibrid_showing")
        self.buttonGroup.addButton(self.gibrid_showing)
        self.label_4 = QtWidgets.QLabel(Form)
        self.label_4.setGeometry(QtCore.QRect(10, 240, 271, 16))
